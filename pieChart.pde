class pieChart {
  ...
  void draw() {
    ...
    fill(245);
    text((nf(((float)onTime/total)*100,0,2)) + "% of flights on time ", 505, 280);
    text((nf(((float)cancelled/total)*100,0,2)) + "% of flights cancelled ", 505, 320);
    text("<0.01% of flights diverted ", 505, 360);
 }
